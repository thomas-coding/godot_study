...
- Mentor troubleshooting knowledge pack (`QA040` + checklists + quick map): `done`
  - Evidence: `02_mentor/qa/QA040_json_keep_text_save_behavior.md`, `04_templates/performance_frame_budget_checklist.md`, `04_templates/windows_release_preflight_checklist.md`, `02_mentor/source_quick_answer_map_v1.md`
