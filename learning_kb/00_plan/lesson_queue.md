...
- 第24课（已完成）：Boss 战能力补齐与区域门控
  - 脚本：`learning_kb/00_plan/lesson_24_2h_runbook.md`
- 第25课（已完成）：复杂 Boss 对象组织与战斗威胁
  - 脚本：`learning_kb/00_plan/lesson_25_2h_runbook.md`
- 第26课（已完成）：输入与交互系统整理
  - 脚本：`learning_kb/00_plan/lesson_26_2h_runbook.md`
- 第27课（已完成）：UI/菜单系统与状态流
  - 脚本：`learning_kb/00_plan/lesson_27_2h_runbook.md`
- 第28课（已完成）：Animation / Tween / Timer 反馈系统
  - 脚本：`learning_kb/00_plan/lesson_28_2h_runbook.md`
- 第29课（已完成）：音频系统基础
  - 脚本：`learning_kb/00_plan/lesson_29_2h_runbook.md`
- 第30课（已完成）：Resource 与数据驱动深化
  - 脚本：`learning_kb/00_plan/lesson_30_2h_runbook.md`

## 备课缓冲检查

- 当前已备课缓冲：第27课~第30课已消耗并完成。
- 缓冲状态：不满足“至少提前 3 课”要求；若继续 `godot_study` 学员线，需要导师线先补第31课~第33课正式 runbook。
...
- 必修建议：第25课~第36课。
- 选修建议：第37课~第42课。
- 备课规则：第25课~第30课已生成正式 runbook 且完成；第31课以后仍为规划参考。
- 下次导师线优先级：若继续 `godot_study` 学习路线，补第31课~第33课 runbook；若转向真实项目，进入独立仓库 `D:\workspace\code\computer_from_scratch`。
